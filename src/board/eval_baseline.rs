// Baseline eval constants from the original engine implementation.
pub const BASELINE_MATERIAL_MG: [i32; 6] = [82, 337, 365, 477, 1025, 20000];
pub const BASELINE_MATERIAL_EG: [i32; 6] = [94, 281, 297, 512, 936, 20000];

pub const BASELINE_PST_MG: [[i32; 64]; 6] = [
    [
    ...
    [
        ...
        3, 0, -5, -33, -36, -26, -12, -1, 9, -7, 6, -23, -24, -11, 7, 26, 24, 35, -8, -20, -5,
        19, 26, 36, 17, 45, 61, 16, 27, 32, 58, 62, 80, 67, 26, 44, 32, 42, 32, 51, 63, 9, 31,
        43,
    ],
    [
    ...
    [
        ...
        -36, -9, 24, 2, -16, -20, 6, 22, -22, 29, -1, -20, -7, -8, -4, -38, -29, -65, 23, 16,
        -15, -56, -34, 2, 13,
    ],
];

pub const BASELINE_PST_EG: [[i32; 64]; 6] = [
    [
    ...
    [
        ...
        15, 10, -3, -20, -22, -18, -6, 16, 25, 16, 17, 4, -18, -17, 3, 22, 22, 22, 11, 8, -18,
        -24, -20, 10, 9, -1, -9, -19, -41, -25, -8, -25, -2, -9, -25, -24, -52, -58, -38, -13,
        -28, -31, -27, -63, -99,
    ],
    [
        -23, -9, -23, -5, -9, -16, -5, -17, -14, -18, -7, -1, 4, -9, -15, -27, -12, -3, 8, 10, 13,
        3, -7, -15, -6, 3, 13, 19, 7, 10, -3, -9, -3, 9, 12, 9, 14, 10, 3, 2, 2, -8, 0, -1, -2,
        6, 0, 4, -8, -4, 7, -12, -3, -13, -4, -14, -14, -21, -11, -8, -7, -9, -17, -24,
    ],
    [
        -9, 2, 3, -1, -5, -13, 4, -20, -6, -6, 0, 2, -9, -9, -11, -3, -4, 0, -5, -1, -7, -12, -8,
        -16, 3, 5, 8, 4, -5, -6, -8, -11, 4, 3, 13, 1, 2, 1, -1, 2, 7, 7, 7, 5, 4, -3, -5, -3,
        11, 13, 13, 11, -3, 3, 8, 3, 13, 10, 18, 15, 12, 12, 8, 5,
    ],
    [
        -33, -28, -22, -43, -5, -32, -20, -41, -22, -23, -30, -16, -16, -23, -36, -32, -16, -27, 15,
        6, 9, 17, 10, 5, -18, 28, 19, 47, 31, 34, 39, 23, 3, 22, 24, 45, 57, 40, 57, 36, -20, 6,
        9, 49, 47, 35, 19, 9, -17, 20, 32, 41, 58, 25, 30, 0, -9, 22, 22, 27, 27, 19, 10, 20,
    ],
    [
...
pub const BASELINE_BISHOP_PAIR: i32 = 30;
pub const BASELINE_ROOK_OPEN: i32 = 15;
pub const BASELINE_ROOK_HALF: i32 = 7;
pub const BASELINE_ROOK_7TH: i32 = 12;
pub const BASELINE_ISOLATED: i32 = 12;
pub const BASELINE_DOUBLED: i32 = 12;
pub const BASELINE_MOBILITY_WEIGHT: i32 = 2;
pub const BASELINE_MINOR_ATTACK: i32 = 6;
